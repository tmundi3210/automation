...
- **Duty / tariff** — Ad-valorem import tax; cotton 6110.20.20 ≈ **16.5%**, wool 6110.11 ~**16%**, acrylic/MMF 6110.30.30 ~**32%** — fibre choice changes the duty (cotton ≈ wool; acrylic is the outlier). `[FACT — USITC/Flexport/UNIS]`. **Any 2025–26 US surcharges / Section-301-type add-ons are `[UNKNOWN]` here → confirm in T9.**
