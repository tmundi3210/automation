...
- **The ratio on the care label is the single biggest cost-and-positioning decision** (SCOPE_GLOSSARY §1). "70/30" vs "50/50" moves cost, hand, warmth, care, **and US import duty** (fibre changes the HTS line — wool 6110.11 ~16% vs cotton 6110.20 ~7%; SCOPE_GLOSSARY §6).
