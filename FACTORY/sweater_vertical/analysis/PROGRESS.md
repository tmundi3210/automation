...
| T9 | Logistics & unit economics | **deep-dive DONE** (CRITICAL: cotton duty is 16.5% not ~7%; acrylic A2 hit by 32% MMF duty; de-minimis repealed Aug-2025; viable led by A3+bundles at CAC<~$35, NOT as paid-social acrylic value brand). Duty error CORRECTED across all upstream KBs/specialists/glossary (cotton 16.5%, acrylic 32%; re-forged + re-gated ALL GREEN); KB build pending | analysis/unit_economics/ |
